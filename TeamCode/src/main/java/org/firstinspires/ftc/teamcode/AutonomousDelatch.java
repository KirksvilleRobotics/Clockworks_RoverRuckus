/*******************************************************************
 * Autonomous file for when the robot is positioned toward a corner
 * (Ideally), this file makes the robot delatch from the landing area,
 * place a team marker in the corner, and drive into the crater with a
 * total amount of 60 points earned
 *******************************************************************/
...
@Autonomous(name = "Autonomous Corner Start")
public class AutonomousDelatch extends LinearOpMode {
